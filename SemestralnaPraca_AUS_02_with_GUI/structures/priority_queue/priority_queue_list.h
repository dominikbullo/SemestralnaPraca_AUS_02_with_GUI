...
namespace structures
{
	...
	{
		if (this != &other) // nikdysám do seba
		{
			clear(); //spodný vyčistím 
			// všetko čo najdem skopirjem cez copy konštruktror

			// stále pracujem so zoznamom a viem, Že je iterovateľny
	...
	{
		// NOTE: remove at mi vymazáva prvok, ale vráti mi dáta, takŽe viem k nim pristúpiŤ zmazať a vrátiŤ
