...
namespace structures
{
	...
	{
		if (dynamic_cast<BinaryTreeNode<T>*>(current))
		{
			//  spracujem laveho syna a zavolam populatePath, nech spracuje jeho dalsieho laveho syna = rekurzia
			populatePath(dynamic_cast<BinaryTreeNode<T>*>(current)->getLeftSon());
			//  spracujem sameho seba
			path_->push(dynamic_cast<BinaryTreeNode<T>*>(current));
			//  spracujem praveho syna a zavolam populatePath, nech spracuje jeho dalsieho praveho syna = rekurzia
