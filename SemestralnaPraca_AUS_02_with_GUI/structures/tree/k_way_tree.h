...
namespace structures
{
	...
	{
		// note alternativa 01 - multiway
		//return children_->size() == 0;

		// note alternativa 02 - multiway
	...
	{
		//children_->insert(dynamic_cast<KWayTreeNode<T, K>*>(son), order);
		//// NOTE alternativa 02
		//if (son)
	...
	{
		// note kwaytree ma stale rovnaky pocet synov
