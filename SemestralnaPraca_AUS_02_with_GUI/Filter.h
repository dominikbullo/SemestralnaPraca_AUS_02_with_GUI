...
{
public:
	bool evaluate(const O& o, const Criterion<T, O>& c) override { T result = c.evaluate(o); return result >= alpha && result <= beta; }
...
{
public:
	bool evaluate(const O& o, const Criterion<T, O>& c) override { return (c.evaluate(o) == this->alpha); }
